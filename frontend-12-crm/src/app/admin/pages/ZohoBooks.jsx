...
const ZohoBooks = () => {
  ...
  const handleConnect = () => {
    ...
    setTimeout(() => {
      setIsConnected(true)
      setIsLoading(false)
      alert('Zoho Books connected successfully!')
    }, 1500)
  }

  const handleDisconnect = () => {
    if (window.confirm('Are you sure you want to disconnect Zoho Books?')) {
      ...
      alert('Zoho Books disconnected successfully!')
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-primary-text">Zoho Books Integration</h1>
        <p className="text-secondary-text mt-1">Connect and manage your Zoho Books account</p>
      </div>
      ...
      <Card className="p-6 bg-white rounded-lg shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-primary-text">Zoho Books</h2>
              <p className="text-sm text-secondary-text">Financial management and accounting</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">
                ✓ Zoho Books is connected and syncing data automatically.
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                Connect your Zoho Books account to sync invoices, payments, and financial data automatically.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              <div>
                ...
                <p className="text-sm text-secondary-text">Automatically sync invoices from Zoho Books</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              <div>
                ...
                <p className="text-sm text-secondary-text">Sync customer data from Zoho Books</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
      ...
      <Card className="p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm text-secondary-text mb-4">
          Learn how to get your Zoho Books API credentials and set up the integration.
        </p>
