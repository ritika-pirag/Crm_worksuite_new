    ...
    <header className="bg-slate-900/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to="/" onClick={handleNavClick} className="text-xl sm:text-2xl font-black text-white tracking-tighter flex items-center gap-2">
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-primary-accent rounded-lg flex items-center justify-center text-white text-xs sm:text-sm shadow-[0_0_15px_rgba(33,126,69,0.5)]">D</div>
            <span className="hidden xs:inline">Develo</span>
            <span className="xs:hidden">Develo</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3 lg:gap-4">
            <Link to="/login">
              <Button variant="ghost" size="sm" className="font-bold text-white hover:text-primary-accent hover:bg-white/10 transition-all duration-300 text-sm lg:text-base px-3 lg:px-4">
                Login
              </Button>
            </Link>
            <Link to="/login">
              <Button variant="primary" size="sm" className="shadow-lg rounded-xl text-sm lg:text-base px-4 lg:px-6">
                Get Started
              </Button>
            </Link>
          </div>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 mt-2">
                <Link to="/login" onClick={() => setMobileMenuOpen(false)}>
                  <Button variant="ghost" size="sm" className="w-full font-bold text-white hover:text-primary-accent hover:bg-white/10 transition-all duration-300">
                    Login
                  </Button>
                </Link>
                <Link to="/login" onClick={() => setMobileMenuOpen(false)}>
                  <Button variant="primary" size="sm" className="w-full shadow-lg rounded-xl">
                    Get Started
                  </Button>
                </Link>
              </div>
