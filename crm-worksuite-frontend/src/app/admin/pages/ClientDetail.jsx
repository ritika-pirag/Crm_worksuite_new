...
const ClientDetail = () => {
  ...
  const handleAddProject = async (shouldClose = true) => {
    try {
      ...
      const projectData = {
        ...
        price: projectFormData.price ? parseFloat(projectFormData.price) : null,
      ...
      if (response.data.success) {
        ...
        setProjectFormData({
          ...
          deadline: '', price: '', status: 'in progress', project_category: '', label: ''
        })
        // Wait a bit then fetch to ensure data is saved
        setTimeout(() => {
          fetchProjects()
  ...
  const handleEditProject = (project) => {
    ...
    setProjectFormData({
      ...
      price: project.price || project.budget || '',
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)] lg:h-[calc(100vh-5rem)] overflow-hidden bg-gray-50 relative w-full">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 md:p-6">
          {activeTab === 'overview' && (
            <div className="space-y-4 sm:space-y-6">
              {/* Main Layout: Left (col-8) + Right Sidebar (col-4) */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                {/* Left Side - Stats Cards (col-8) */}
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                          <IoBriefcase className="text-blue-600" size={20} />
                        </div>
                      </div>
                    </Card>
                    ...
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                          <IoDocumentText className="text-green-600" size={20} />
                        </div>
                      </div>
                    </Card>
                    ...
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                          <IoCash className="text-purple-600" size={20} />
                        </div>
                      </div>
                    </Card>
                    ...
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                          <IoCard className="text-orange-600" size={20} />
                        </div>
                      </div>
                    </Card>
                    ...
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center">
                          <IoFileTray className="text-red-600" size={20} />
                        </div>
                      </div>
                    </Card>
                    ...
                    <Card className="p-4 bg-white border border-gray-200 hover:shadow-md transition-shadow">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600 font-medium">Estimates</p>
                          <p className="text-2xl font-bold text-gray-900 mt-1">{estimates.length}</p>
                        </div>
                        <div className="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center">
                          <IoFileTrayFull className="text-indigo-600" size={20} />
                        </div>
                      </div>
                    </Card>
                  </div>
                  ...
                  <Card className="p-6 bg-white border border-gray-200">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      >
                        View All
                        <IoChevronDown size={16} className="rotate-270" />
                      </button>
                    </div>
                      ...
                      <div className="p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-medium text-gray-900">{client?.client_name || client?.name || 'Primary Contact'}</p>
                              <p className="text-sm text-gray-600">{client?.email || '-'}</p>
                              <p className="text-sm text-gray-600">{client?.phone ? `${client?.phoneCountryCode || ''} ${client?.phone}` : '-'}</p>
                            </div>
                          </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                          <IoDocumentText className="text-blue-600" size={14} />
                        </div>
                        <div className="flex-1">
                          <p className="text-sm font-medium text-gray-900">New invoice created</p>
                          <p className="text-xs text-gray-600 mt-1">Invoice #INV-002 was created</p>
                      ...
                      <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                          <IoPerson className="text-purple-600" size={14} />
                        </div>
                        <div className="flex-1">
                          <p className="text-sm font-medium text-gray-900">Client updated</p>
                          <p className="text-xs text-gray-600 mt-1">Client information was updated</p>
                ...
                {/* Right Sidebar - Client Info (col-4) */}
                    ...
                    <table className="w-full min-w-[900px]">
                      <thead className="bg-white border-b border-gray-200">
                        <tr>
                          ...
                          <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Start date</th>
                          ...
                          .map((project) => (
                            <tr key={project.id} className="hover:bg-gray-50 transition-colors">
                              ...
                              <td className="px-6 py-4 text-sm text-gray-500">
                                {project.price || project.budget ? formatCurrency(project.price || project.budget) : '-'}
                              </td>
                              <td className="px-6 py-4 text-sm text-gray-500">
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-2">
                                  <div className="w-full bg-gray-200 rounded-full h-1.5 flex-1 overflow-hidden">
                                    <div className="bg-gray-300 h-1.5 rounded-full" style={{ width: `${project.progress || 0}%` }}></div>
                                  </div>
                                </div>
                              </td>
                              <td className="px-6 py-4">
                              ...
                              <td className="px-6 py-4 text-right text-sm font-medium">
                                <div className="flex items-center justify-end gap-2">
                                  <button onClick={() => handleEditProject(project)} className="p-1.5 text-gray-400 hover:text-gray-600 border border-gray-200 rounded-full hover:bg-gray-50 transition-colors">
                                    <IoCreate size={14} />
                                  </button>
                                  <button onClick={() => handleDeleteProject(project)} className="p-1.5 text-gray-400 hover:text-red-600 border border-gray-200 rounded-full hover:bg-red-50 transition-colors">
                                    <IoClose size={14} />
                                  </button>
                                </div>
                              </td>
      ...
      >
        <div className="space-y-4">
          ...
          {/* Hidden Status Field (default 'in progress') or keep it? user didn't ask for it in modal explicit fields list but it's useful. 
              The prompt list: "Title, Description, Start Date, Deadline, Price, Labels". 
              I'll hide Status or put it in labels row if needed but for now I'll stick to the requirements.
              Actually, Status is vital. I'll keep it but maybe less prominent or as per screenshot if visible.
              Screenshot shows Labels.
              I'll skip Status dropdown if not requested, or keep it. I'll keep it hidden or default.
              Wait, the "Projects List UI" has a "Status" column.
              If I don't provide a way to set it, it's always "in progress".
              I'll add it as optional or just default. I'll omit it to strictly follow "Add Project Modal ... fields (Title, Description, Start Date, Deadline, Price, Labels)".
          */}
