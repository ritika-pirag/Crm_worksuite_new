  ...
  const fetchLeads = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        // Apply new detailed filters
        if (filterOwner) {
          filtered = filtered.filter(l => l.employeeId == filterOwner)
        }
        if (filterStatus) {
        ...
        if (filterDate) {
          filtered = filtered.filter(l => l.createdDate === filterDate)
        }
        ...
        return (
          <div className="flex flex-wrap gap-1">
            {labelNames.map((labelName, idx) => {
              // Find the label color from the labels state (which now contains objects)
    ...
    isViewModalOpen && selectedLead ? (
      ...
      <div className="space-y-3 sm:space-y-4 md:space-y-6 w-full">
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 md:p-5 w-full">
          ...
          <div className="flex flex-col gap-4 mb-6 bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center bg-white border border-gray-300 rounded overflow-hidden">
                  <button
                    className="px-3 py-1.5 flex items-center gap-2 text-sm text-gray-700 font-medium hover:bg-gray-50"
                    onClick={() => setIsFilterOpen(!isFilterOpen)}
                  >
                    <IoFilter size={16} /> Filter
                  </button>
                ...
                <button
                  onClick={() => setIsFilterOpen(!isFilterOpen)}
                  className={`w-9 h-9 flex items-center justify-center rounded transition-all ${isFilterOpen
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm font-medium rounded transition-all border ${probabilityFilter === '50'
                    ? 'bg-[#fff59d] text-yellow-800 border-[#fff59d]'
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm font-medium rounded transition-all border ${probabilityFilter === '90'
                ...
                <button
                  ...
                  className={`w-9 h-9 flex items-center justify-center rounded-full border transition-all ${activeFilter === 'call'
                    ? 'bg-blue-100 text-blue-600 border-blue-200'
                    : 'bg-white border-gray-300 text-gray-400 hover:text-blue-600 hover:border-blue-300'}`}
                  title="Calls Only"
                >
                  <IoCall size={16} />
                </button>

                {/* My Leads (User) Filter */}
                <button
                  onClick={() => setActiveFilter(activeFilter === 'my' ? 'all' : 'my')}
                  className={`w-9 h-9 flex items-center justify-center rounded-full border transition-all ${activeFilter === 'my'
                    ? 'bg-gray-800 text-white border-gray-800'
                    : 'bg-white border-gray-300 text-gray-400 hover:text-gray-800 hover:border-gray-400'}`}
                  title="My Leads"
                >
                  <IoPerson size={16} />
                </button>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <button className="px-3 py-1.5 bg-white border border-gray-300 rounded text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-2 transition-colors">
        ...
        {/* View Modal - Lead Details (Rise CRM Style) */}
        <Modal
          ...
          {selectedLead && (
            <div className="h-full flex flex-col font-sans text-primary-text">
              ...
              <div className="flex items-center gap-6 border-b border-gray-200 mb-6 text-sm font-medium text-gray-600 overflow-x-auto">
                <button className="pb-3 border-b-2 border-primary-accent text-primary-accent px-1">Overview</button>
                <button className="pb-3 border-b-2 border-transparent hover:border-gray-300 px-1">Estimates</button>
                <button className="pb-3 border-b-2 border-transparent hover:border-gray-300 px-1">Proposals</button>
                <button className="pb-3 border-b-2 border-transparent hover:border-gray-300 px-1">Contracts</button>
                <button className="pb-3 border-b-2 border-transparent hover:border-gray-300 px-1">Files</button>
              </div>
                ...
                <div className="w-full lg:w-1/3 space-y-6">
                  <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button className="text-gray-400 hover:text-gray-600"><IoEllipsisHorizontal /></button>
                    </div>
                  ...
                  <div className="bg-white rounded-lg p-5 border border-gray-200">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-bold text-gray-800 flex items-center gap-2">
                        <IoCheckmarkCircleOutline /> Tasks
                      </h3>
                    </div>
                  ...
                  <div className="bg-white rounded-lg p-5 border border-gray-200">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-bold text-gray-800 flex items-center gap-2">
                        <IoTimeOutline /> Reminders (Private)
                      </h3>
                    </div>
                    <button className="text-sm text-blue-600 hover:underline flex items-center gap-1 mt-2">
                      <IoAdd /> Add reminder
