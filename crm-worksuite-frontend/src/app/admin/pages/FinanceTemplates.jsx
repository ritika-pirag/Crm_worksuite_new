...
import { IoCreate, IoTrash, IoEye, IoDocumentText, IoColorPalette, IoDownload } from 'react-icons/io5'
      ...
      >
        <div className="space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-accent transition-colors cursor-pointer">
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary-accent focus:border-primary-accent outline-none font-mono text-sm"
              placeholder="Enter template HTML/CSS code..."
            />
