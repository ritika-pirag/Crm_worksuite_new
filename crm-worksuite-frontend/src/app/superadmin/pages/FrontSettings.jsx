...
const FrontSettings = () => {
  const [formData, setFormData] = useState({
    site_name: 'Worksuite CRM',
    site_description: 'Complete CRM Solution',
    site_logo: '',
    site_favicon: '',
    contact_email: 'support@worksuite.com',
      ...
      <Card className="p-5">
        ...
        <div className="space-y-4">
          <Input
            ...
            placeholder="support@worksuite.com"
          />
      ...
      <Card className="p-5">
        ...
        <div className="space-y-4">
          <Input
            ...
            placeholder="https://facebook.com/worksuite"
          />
          ...
          <Input
            ...
            placeholder="https://twitter.com/worksuite"
          />
          ...
          <Input
            ...
            placeholder="https://linkedin.com/company/worksuite"
          />
        </div>
      </Card>
